			...
			<section className="grid justify-center p-8">
				<div className="prose prose-lg prose-zinc tracking-tight dark:prose-invert">
					...
					<p>
						...
						<span className="font-semibold">our</span>&quot;), a company
						registered in Canada at 73C Boulevard des Prairies, Laval, Quebec
						H7N2T2.
					</p>
					<p>
						We operate the website rentorbuyaplane.com (the &quot;
						<span className="font-semibold">Site</span>&quot;), as well as any
					...
					<p>
						You can contact us by email at contact@raccoonv.com or by mail to
						73C Boulevard des Prairies, Laval, Quebec H7N2T2,&nbsp;Canada.
					</p>
					<p>
						These Legal Terms constitute a legally binding agreement made
						between you, whether personally or on behalf of an entity (&quot;
						<span className="font-semibold">you</span>&quot;), and Raccoon
						Ventures Inc., concerning your access to and use of the Services.
					...
					<p>
						...
						displayed, encoded, tranzincd, transmitted, distributed, sold,
					...
					<p>
						...
						please address your request to: contact@raccoonv.com. If we ever
					...
					<p>
						...
						other information about the Services (&quot;Submissions&quot;), you
					...
					<p>
						<span className="font-semibold">
							...
							publicly perform, publicly display, reformat, tranzinc, excerpt
					...
					<ul>
						<li>
							...
							<a href="#prohibited">
								...
								upload, or transmit through the Services any Submission nor post
					...
					<p>
						...
						third party&rsquo;s intellectual property rights, or (c) applicable
						law.
					</p>
					<p>
						<span className="font-semibold">
					...
					<ul>
						...
						<li>
							...
							and every identifiable inpidual person in your Contributions to
							use the name or likeness of each and every such identifiable
							inpidual person to enable inclusion and use of your Contributions
					...
					<p>
						...
						cache, publicly perform, publicly display, reformat, tranzinc,
					...
					<p>
						...
						Policy: &nbsp;
						<a href="https://rentorbuyaplane.com/privacy" target="_blank">
					...
					<p>
						...
						laws of Canada. Raccoon Ventures Inc. and yourself irrevocably
					...
					<p>
						...
						controversy, or claim related to these Legal Terms &lpar;each a
						&quot;Dispute&quot; and collectively, the &quot;Disputes&quot;&rpar;
						brought by either you or us &lpar;inpidually, a &quot;Party&quot;
						and collectively, the &quot;Parties&quot;&rpar;, the Parties agree
						to first attempt to negotiate any Dispute &lpar;except those
						Disputes expressly provided below&rpar; informally for at least
						thirty &lpar;30&rpar; days before initiating arbitration. Such
					...
					<p>
						...
						Arbitration Chamber &lpar;Belgium, Brussels, Avenue Louise,
						146&rpar; according to the Rules of this ICAC, which, as a result of
						referring to it, is considered as the part of this clause. The
						number of arbitrators shall be one &lpar;1&rpar;. The seat, or legal
						place, or arbitration shall be Montr&eacute;al, Canada. The language
						of the proceedings shall be French. The governing law of these Legal
					...
					<p>
						...
						Dispute between the Parties inpidually. To the full extent permitted
						by law, &lpar;a&rpar; no arbitration shall be joined with any other
						proceeding; &lpar;b&rpar; there is no right or authority for any
						Dispute to be arbitrated on a class-action basis or to utilize class
						action procedures; and &lpar;c&rpar; there is no right or authority
					...
					<p>
						...
						arbitration: &lpar;a&rpar; any Disputes seeking to enforce or
						protect, or concerning the validity of, any of the intellectual
						property rights of a Party; &lpar;b&rpar; any Dispute related to, or
						arising from, allegations of theft, piracy, invasion of privacy, or
						unauthorized use; and &lpar;c&rpar; any claim for injunctive relief.
					...
					<p>
						...
						&lpar;1&rpar; ERRORS, MISTAKES, OR INACCURACIES OF CONTENT AND
						MATERIALS, &lpar;2&rpar; PERSONAL INJURY OR PROPERTY DAMAGE, OF ANY
						NATURE WHATSOEVER, RESULTING FROM YOUR ACCESS TO AND USE OF THE
						SERVICES, &lpar;3&rpar; ANY UNAUTHORIZED ACCESS TO OR USE OF OUR
						SECURE SERVERS AND/OR ANY AND ALL PERSONAL INFORMATION AND/OR
						FINANCIAL INFORMATION STORED THEREIN, &lpar;4&rpar; ANY INTERRUPTION
						OR CESSATION OF TRANSMISSION TO OR FROM THE SERVICES, &lpar;5&rpar;
						ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE WHICH MAY BE
						TRANSMITTED TO OR THROUGH THE SERVICES BY ANY THIRD PARTY, AND/OR
						&lpar;6&rpar; ANY ERRORS OR OMISSIONS IN ANY CONTENT AND MATERIALS
					...
					<p>
						...
						US&nbsp;DURING THE six &lpar;6&rpar; mONTH PERIOD PRIOR TO ANY CAUSE
					...
					<p>
						...
						&lpar;1&rpar; your Contributions;&nbsp;&lpar;2&rpar; use of the
						Services; &lpar;3&rpar; breach of these Legal Terms; &lpar;4&rpar;
						any breach of your representations and warranties set forth in these
						Legal Terms; &lpar;5&rpar; your violation of the rights of a third
						party, including but not limited to intellectual property rights; or
						&lpar;6&rpar; any overt harmful act toward any other user of the
					...
					<p>
						...
						95834 or by telephone at &lpar;800&rpar; 952-5210 or &lpar;916&rpar;
						445-1254.
					</p>
					<p>
