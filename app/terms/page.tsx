const TermsPage = () => {
	return (
		<div className="h-full">
			<div className="grid items-center space-y-5 text-center font-bold text-zinc-950 dark:text-zinc-50">
				<h1 className="text-4xl font-semibold md:text-6xl">Terms & Conditions</h1>
			...
			<section className="grid justify-center p-8">
				<div className="prose prose-lg prose-zinc dark:prose-invert tracking-tight">
					...
					<p>
						We are Raccoon Ventures Inc., doing business as rentorbuyaplane.com
						(&quot;
						<span className="font-semibold">Company</span>&quot;, &quot;
						<span className="font-semibold">we</span>&quot;, &quot;
						<span className="font-semibold">us</span>&quot;, &quot;
						<span className="font-semibold">our</span>&quot;), a company registered in
						Canada at 73C Boulevard des Prairies, Laval, Quebec H7N2T2.
					</p>
					<p>
						We operate the website rentorbuyaplane.com (the &quot;
						<span className="font-semibold">Site</span>&quot;), as well as any other
					...
					<p>
						You can contact us by email at contact@raccoonv.com or by mail to 73C
						Boulevard des Prairies, Laval, Quebec H7N2T2,&nbsp;Canada.
					</p>
					<p>
						These Legal Terms constitute a legally binding agreement made between you,
						whether personally or on behalf of an entity (&quot;
						<span className="font-semibold">you</span>&quot;), and Raccoon Ventures
					...
					<p>
						<span className="font-semibold">1. OUR SERVICES </span>
					</p>
					<p>
					...
					<p>
						<span className="font-semibold">2. INTELLECTUAL PROPERTY RIGHTS </span>
					</p>
					<p>
					...
					<p>
						<span className="font-semibold">Your use of our Services</span>
					</p>
					<p>
					...
					<p>
						...
						tranzincd, transmitted, distributed, sold, licensed, or otherwise
					...
					<p>
						...
						your request to: contact@raccoonv.com. If we ever grant you the permission
					...
					<p>
						<span className="font-semibold">Your submissions and contributions</span>
					</p>
					<p>
					...
					<p>
						<span className="font-semibold">Submissions:</span> By directly sending us
					...
					<p>
						<span className="font-semibold">
							...
							tranzinc, excerpt (in whole or in part), and exploit your Contributions
							...
							sublicense the licenses granted in this section. Our use and distribution
					...
					<p>
						<span className="font-semibold">We may remove or edit your Content:</span>{" "}
						...
						if in our reasonable opinion we consider such Contributions harmful or in
						breach of these Legal Terms. If we remove or edit any such Contributions,
						we may also suspend or disable your account and report you to the
						authorities.
					</p>
					<p>
					...
					<p>
						...
						<a href="#copyrightyes">COPYRIGHT INFRINGEMENTS&quot; section below.</a>
					</p>
					<p>
						<span className="font-semibold">3.&nbsp;USER REPRESENTATIONS </span>
					</p>
					<p>
						...
						non-human means, whether through a bot, script or otherwise; (6) you will
						not use the Services for any illegal or unauthorized purpose; and (7) your
					...
					<p>
						<span className="font-semibold">4.&nbsp;USER REGISTRATION </span>
					</p>
					<p>
					...
					<p>
						<span className="font-semibold">5.&nbsp;PURCHASES AND PAYMENT </span>
					</p>
					...
					<p>
						<span className="font-semibold">6. SUBSCRIPTIONS </span>
					</p>
					<p>
						<span className="font-semibold">Billing and Renewal </span>
					</p>
					<p>
					...
					<p>
						...
						unsatisfied with our Services, please email us at contact@raccoonv.com.
						<br />
					</p>
					<p>
					...
					<p>
						<span className="font-semibold">7.&nbsp;PROHIBITED ACTIVITIES </span>
					</p>
					<p>
					...
					<ul>
						...
						<li>
							...
							any party&rsquo;s uninterrupted use and enjoyment of the Services or
						...
						<li>
							...
							formats (&quot;gifs&quot;), 1&times;1 pixels, web bugs, cookies, or other
					...
					<ul>
						...
						<li>
							...
							every identifiable inpidual person in your Contributions to use the name
							or likeness of each and every such identifiable inpidual person to enable
					...
					<p>
						<span className="font-semibold">9.&nbsp;CONTRIBUTION LICENSE</span>
					</p>
					<p>
						...
						publicly display, reformat, tranzinc, transmit, excerpt (in whole or in
					...
					<p>
						<span className="font-semibold">11.&nbsp;SERVICES MANAGEMENT </span>
					</p>
					<p>
					...
					<p>
						<span className="font-semibold">12.&nbsp;PRIVACY POLICY </span>
					</p>
					<p>
						We care about data privacy and security. Please review our Privacy Policy:
						&nbsp;
						<a
							href="https://rentorbuyaplane.com/privacy"
							target="_blank"
							rel="noopener"
						>
							https://rentorbuyaplane.com/privacy.
						</a>{" "}
					...
					<p>
						<span className="font-semibold">13.&nbsp;COPYRIGHT INFRINGEMENTS </span>
					</p>
					<p>
						We respect the intellectual property rights of others. If you believe that
						any material available on or through the Services infringes upon any
					...
					<p>
						<span className="font-semibold">14.&nbsp;TERM AND TERMINATION </span>
					</p>
					<p>
					...
					<p>
						<span className="font-semibold">16.&nbsp;GOVERNING LAW </span>
					</p>
					<p>
						These Legal Terms shall be governed by and defined following the laws of
						Canada. Raccoon Ventures Inc. and yourself irrevocably consent that the
						courts of Canada shall have exclusive jurisdiction to resolve any dispute
						which may arise in connection with these Legal Terms.
					</p>
					<p>
						<span className="font-semibold">17.&nbsp;DISPUTE RESOLUTION </span>
					</p>
					<p>
					...
					<p>
						...
						or claim related to these Legal Terms &lpar;each a &quot;Dispute&quot; and
						collectively, the &quot;Disputes&quot;&rpar; brought by either you or us
						&lpar;inpidually, a &quot;Party&quot; and collectively, the
						&quot;Parties&quot;&rpar;, the Parties agree to first attempt to negotiate
						any Dispute &lpar;except those Disputes expressly provided below&rpar;
						informally for at least thirty &lpar;30&rpar; days before initiating
					...
					<p>
						...
						Arbitration Court under the European Arbitration Chamber &lpar;Belgium,
						Brussels, Avenue Louise, 146&rpar; according to the Rules of this ICAC,
						which, as a result of referring to it, is considered as the part of this
						clause. The number of arbitrators shall be one &lpar;1&rpar;. The seat, or
						legal place, or arbitration shall be Montr&eacute;al, Canada. The language
						of the proceedings shall be French. The governing law of these Legal Terms
					...
					<p>
						...
						between the Parties inpidually. To the full extent permitted by law,
						&lpar;a&rpar; no arbitration shall be joined with any other proceeding;
						&lpar;b&rpar; there is no right or authority for any Dispute to be
						arbitrated on a class-action basis or to utilize class action procedures;
						and &lpar;c&rpar; there is no right or authority for any Dispute to be
					...
					<p>
						...
						&lpar;a&rpar; any Disputes seeking to enforce or protect, or concerning
						the validity of, any of the intellectual property rights of a Party;
						&lpar;b&rpar; any Dispute related to, or arising from, allegations of
						theft, piracy, invasion of privacy, or unauthorized use; and &lpar;c&rpar;
						any claim for injunctive relief. If this provision is found to be illegal
					...
					<p>
						<span className="font-semibold">18.&nbsp;CORRECTIONS </span>
					</p>
					<p>
					...
					<p>
						<span className="font-semibold">19. DISCLAIMER </span>
					</p>
					<p>
						...
						&lpar;1&rpar; ERRORS, MISTAKES, OR INACCURACIES OF CONTENT AND MATERIALS,
						&lpar;2&rpar; PERSONAL INJURY OR PROPERTY DAMAGE, OF ANY NATURE
						WHATSOEVER, RESULTING FROM YOUR ACCESS TO AND USE OF THE SERVICES,
						&lpar;3&rpar; ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS
						AND/OR ANY AND ALL PERSONAL INFORMATION AND/OR FINANCIAL INFORMATION
						STORED THEREIN, &lpar;4&rpar; ANY INTERRUPTION OR CESSATION OF
						TRANSMISSION TO OR FROM THE SERVICES, &lpar;5&rpar; ANY BUGS, VIRUSES,
						TROJAN HORSES, OR THE LIKE WHICH MAY BE TRANSMITTED TO OR THROUGH THE
						SERVICES BY ANY THIRD PARTY, AND/OR &lpar;6&rpar; ANY ERRORS OR OMISSIONS
					...
					<p>
						<span className="font-semibold">20.&nbsp;LIMITATIONS OF LIABILITY </span>
					</p>
					<p>
						...
						US&nbsp;DURING THE six &lpar;6&rpar; mONTH PERIOD PRIOR TO ANY CAUSE OF
					...
					<p>
						<span className="font-semibold">21.&nbsp;INDEMNIFICATION </span>
					</p>
					<p>
						...
						made by any third party due to or arising out of: &lpar;1&rpar; your
						Contributions;&nbsp;&lpar;2&rpar; use of the Services; &lpar;3&rpar;
						breach of these Legal Terms; &lpar;4&rpar; any breach of your
						representations and warranties set forth in these Legal Terms;
						&lpar;5&rpar; your violation of the rights of a third party, including but
						not limited to intellectual property rights; or &lpar;6&rpar; any overt
					...
					<p>
						<span className="font-semibold">22.&nbsp;USER DATA </span>
					</p>
					<p>
					...
					<p>
						...
						&lpar;800&rpar; 952-5210 or &lpar;916&rpar; 445-1254.
					</p>
					<p>
						<span className="font-semibold">25. MISCELLANEOUS </span>
					</p>
					<p>
					...
					<p>
						<span className="font-semibold">26.&nbsp;CONTACT US </span>
					</p>
					<p>
					...
					<p>
						<span className="font-semibold">Raccoon Ventures Inc.</span>
					</p>
					<p>
						<span className="font-semibold">73C Boulevard des Prairies </span>
					</p>
					<p>
						<span className="font-semibold">Laval, Quebec H7N2T2 </span>
					</p>
					<p>
					...
					<p>
						<span className="font-semibold">
							<span className="font-semibold">contact@raccoonv.com </span>
						</span>
					</p>
				</div>
			</section>
