	...
	return (
		<div className="h-full">
			<div className="grid items-center space-y-5 text-center font-bold text-zinc-950 dark:text-zinc-50">
				<h1 className="text-4xl font-semibold md:text-6xl">Privacy Policy</h1>
			...
			<section className="grid justify-center p-8">
				<div className="prose prose-lg prose-zinc dark:prose-invert tracking-tight">
					<p>
						This privacy notice for Raccoon Ventures Inc. (doing business as
						rentorbuyaplane.com) (&quot;
					...
					<ul>
						<li>
							...
							<a href="rentorbuyaplane.com">rentorbuyaplane.com</a>, or any website of
					...
					<p>
						...
						exercise your rights is by emailing contact@raccoonv.com, or by contacting
					...
					<p>
						...
						INFORMATION? &quot; above), in Canada, and other countries.
					</p>
					<p>
					...
					<p>
						...
						Clauses for transfers of personal information between our group companies
						and between us and our third-party providers. These clauses require all
					...
					<ul>
						...
						<li>
							...
							personal information to third parties. Upon receiving an opt-out request,
							we will act upon the request as soon as feasibly possible, but no later
							than fifteen (15) days from the date of the request submission.
						</li>
					</ul>
					<p>
						To exercise these rights, you can contact us by email at{" "}
						contact@raccoonv.com , or by referring to the contact details at the
					...
					<p>
						...
						Privacy Act (CPA), you have the rights listed below. However, these rights
					...
					<p>
						...
						our decision, please email us at contact@raccoonv.com . Within forty-five
					...
					<p>
						If we decline to take action regarding your request and you wish to appeal
						our decision, please email us at contact@raccoonv.com . Within sixty (60)
					...
					<p>You may contact us by email at contact@raccoonv.com .</p>
					<p>
					...
					<p>
						...
						please email us at contact@raccoonv.com . Within sixty (60) days of
						...
						the reasons for the decisions. If your appeal is denied, you may contact
						the{" "}
					...
					<p>
						...
						Data Protection Officer (DPO), Jean-Pierre Valery, by email at 
						contact@raccoonv.com , or contact us by post at:
					</p>
					<p>Raccoon Ventures Inc.</p>
					<p>Jean-Pierre Valery</p>
					<p>73C Boulevard des Prairies</p>
					<p>Laval, Quebec H7N2T2</p>
					<p>Canada</p>
					<p>
						<strong>
