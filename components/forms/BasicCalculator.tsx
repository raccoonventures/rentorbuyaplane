...
import { FuelRateToggle } from "@/components/forms/FuelRateToggle";
...
export function BasicCalculator({
	...
	return (
		<div className="grid grid-flow-row gap-8 lg:grid-cols-5">
			{/* Inputs */}
			<div className="grid grid-flow-row gap-8 rounded-lg border border-black/10 bg-zinc-950/5 p-6 lg:col-span-2 lg:p-8 dark:border-white/10 dark:bg-white/5">
				...
				<FuelRateToggle
					isWet={formData.costs?.rental?.isWet ?? false}
