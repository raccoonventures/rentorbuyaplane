	...
	return (
		<>
			<form onSubmit={handleSubmit}>
				<div className="grid grid-flow-col gap-36 pb-12 items-start">
					{/* X */}

					<div className="grid grid-flow-row gap-16">
						{/* Aircraft Details */}
						<div className="grid grid-flow-row gap-6">
							<h1 className="text-[#FF7124]">Aircraft Details</h1>
						...
						{/* Partnership Details */}
						<div className="grid grid-flow-row gap-6">
							<h1 className="text-[#FF7124]">Partnership Details</h1>
							<div className="grid grid-flow-row gap-4">
								<HeadlessField className="grid grid-flow-row gap-2">
					...
					<div className="grid grid-flow-row gap-16">
						{/* Rental Details */}
						<div className="grid grid-flow-row gap-6">
							<h1 className="text-[#FF7124]">Rental Details</h1>
							<div className="grid grid-flow-row gap-4">
								<HeadlessField className="grid grid-flow-row gap-2">
						...
						{/* Financing Details */}
						<div className="grid grid-flow-row gap-6">
							<h1 className="text-[#FF7124]">Financing Details</h1>
							<div className="grid grid-flow-row gap-4">
								<HeadlessField className="grid grid-flow-row gap-2">
								...
								<div className="grid grid-flow-col gap-2 items-baseline">
									<HeadlessField className="grid grid-flow-row gap-2">
										<Label>Duration (Years)</Label>
										<Input
											type="number"
											name="costs.acquisition.durationYears"
											defaultValue={formData?.costs?.acquisition?.durationYears}
											className="max-w-28"
											onChange={handleChange}
										/>
									</HeadlessField>

									<span className="text-gray-500 sm:text-sm px-0.5">@</span>
						...
						{/* Costs */}
						<div className="grid grid-flow-row gap-6">
							<h1 className="text-[#FF7124]">Costs</h1>
							<div className="grid grid-flow-row gap-4">
								<HeadlessField className="grid grid-flow-row gap-2">
					...
					<div className="grid grid-flow-row gap-16">
						...
						<div className="grid grid-flow-row gap-6">
							<h1 className="text-[#FF7124]">Fixed Operation Costs</h1>
							<div className="grid grid-flow-row gap-4">
								<HeadlessField className="grid grid-flow-row gap-2">
									<Label>Hangar</Label>
									<div className="relative">
										...
										<Input
											...
											onChange={handleChange}
											defaultValue={formData?.costs?.operation?.fixed?.hangar}
										/>
										<div className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-12">
								...
								<HeadlessField className="grid grid-flow-row gap-2">
									...
									<div className="relative">
										...
										<Input
											...
											onChange={handleChange}
											defaultValue={formData?.costs?.operation?.fixed?.annual}
										/>
										<div className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-12">
											<span className="text-gray-500 sm:text-sm">/month</span>
										</div>
						...
						<div className="grid grid-flow-row gap-6">
							<h1 className="text-[#FF7124]">Variable Operation Costs</h1>
							<div className="grid grid-flow-row gap-4">
								<HeadlessField className="grid grid-flow-row gap-2">
									<Label>Fuel</Label>
									<div className="relative">
